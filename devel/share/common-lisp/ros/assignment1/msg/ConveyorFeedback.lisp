...
(cl:defmethod cl:initialize-instance :after ((m <ConveyorFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConveyorFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name assignment1-msg:<ConveyorFeedback> is deprecated: use assignment1-msg:ConveyorFeedback instead.")))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <ConveyorFeedback>))
