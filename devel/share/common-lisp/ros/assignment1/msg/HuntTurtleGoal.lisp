...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<HuntTurtleGoal>)))
  ...
  "0cb907047e6d468ef1ec1e0d0f7d469d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'HuntTurtleGoal)))
  "Returns md5sum for a message object of type 'HuntTurtleGoal"
  "0cb907047e6d468ef1ec1e0d0f7d469d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HuntTurtleGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#goal definition~%float32 hunterX~%float32 hunterY~%float32 hunterTheta~%string hunterName~%float32 targetX~%float32 targetY~%float32 targetTheta~%string targetName~%int32 targetId~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HuntTurtleGoal)))
  "Returns full string definition for message of type 'HuntTurtleGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#goal definition~%float32 hunterX~%float32 hunterY~%float32 hunterTheta~%string hunterName~%float32 targetX~%float32 targetY~%float32 targetTheta~%string targetName~%int32 targetId~%~%~%"))
