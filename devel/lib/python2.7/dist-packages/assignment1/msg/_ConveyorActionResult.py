...
"""autogenerated by genpy from assignment1/ConveyorActionResult.msg. Do not edit."""
import sys
...
class ConveyorActionResult(genpy.Message):
  _md5sum = "3fa2b15df3c07c71945669df816f357b"
  _type = "assignment1/ConveyorActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','assignment1/ConveyorResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ConveyorActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = assignment1.msg.ConveyorResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = assignment1.msg.ConveyorResult()
