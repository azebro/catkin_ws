...
"""autogenerated by genpy from assignment1/StartAssignmentActionResult.msg. Do not edit."""
import sys
...
class StartAssignmentActionResult(genpy.Message):
  _md5sum = "b2935e9d98a16e968018a8d438b927c7"
  _type = "assignment1/StartAssignmentActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','assignment1/StartAssignmentResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StartAssignmentActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = assignment1.msg.StartAssignmentResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = assignment1.msg.StartAssignmentResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.result.turtlesCollected
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.turtlesCollected = str[start:end].decode('utf-8')
      else:
        self.result.turtlesCollected = str[start:end]
      return self
