...
class HuntTurtleGoal(genpy.Message):
  _md5sum = "0cb907047e6d468ef1ec1e0d0f7d469d"
...
int32 targetId
"""
  __slots__ = ['hunterX','hunterY','hunterTheta','hunterName','targetX','targetY','targetTheta','targetName','targetId']
  _slot_types = ['float32','float32','float32','string','float32','float32','float32','string','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       hunterX,hunterY,hunterTheta,hunterName,targetX,targetY,targetTheta,targetName,targetId
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.targetId))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.targetId,) = _get_struct_i().unpack(str[start:end])
      return self
